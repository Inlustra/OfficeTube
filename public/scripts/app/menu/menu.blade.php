<div class="bg">
    <ul id="slide-out" class="side-nav fixed bg tfg">
        <li class="logo bg center-align valign">
            <div class="fill valign-wrapper">
                <img class="center-block valign" src="{{asset('img/logo.png')}}"/>
            </div>
        </li>
        <li class="no-padding">
            <ul class="collapsible collapsible-accordion bg tfg">
                <li class="bold"><a class="collapsible-header waves-effect waves-teal">Rooms</a>
                    <div class="collapsible-body ">
                        <ul class="bgl tfg">
                            <li class="tfg"><a href="color.html"><i class="mdi-toggle-star"></i> Top Rooms</a></li>
