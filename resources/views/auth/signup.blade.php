...
@section('main')
		...
		<section>
    	    	...
    	    	<div class="background darken-3 login-box text-background text-lighten-3">
            			<div class="center">
            				<h1 class="">Welcome to Vote<span class="text-mainAccent text-accent-4">Play</span>! </h1><span>A few questions, if you don't mind...</span>
            			</div>
            			<section>
            					...
            					<div class="simform-inner">
            						<ol class="questions">
            							<li>
            								...
            								<input class="text-background text-lighten-3" id="q1" name="q1" type="text"/>
            							</li>
            							<li>
            		...
            		<script src="build/js/stepsForm.js"></script>
            		<script>
